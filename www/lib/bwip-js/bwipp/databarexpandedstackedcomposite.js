...
if (!BWIPJS.bwipp["raiseerror"] && BWIPJS.increfs("databarexpandedstackedcomposite", "raiseerror")) {
	BWIPJS.load("bwipp/raiseerror.js");
}
if (!BWIPJS.bwipp["databarexpandedstacked"] && BWIPJS.increfs("databarexpandedstackedcomposite", "databarexpandedstacked")) {
	BWIPJS.load("bwipp/databarexpandedstacked.js");
}
if (!BWIPJS.bwipp["gs1-cc"] && BWIPJS.increfs("databarexpandedstackedcomposite", "gs1-cc")) {
	BWIPJS.load("bwipp/gs1-cc.js");
}
if (!BWIPJS.bwipp["renmatrix"] && BWIPJS.increfs("databarexpandedstackedcomposite", "renmatrix")) {
...
BWIPJS.decrefs("databarexpandedstackedcomposite");
