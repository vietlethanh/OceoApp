...
// BEGIN telepennumeric
if (!BWIPJS.bwipp["raiseerror"] && BWIPJS.increfs("telepennumeric", "raiseerror")) {
	BWIPJS.load("bwipp/raiseerror.js");
}
if (!BWIPJS.bwipp["renlinear"] && BWIPJS.increfs("telepennumeric", "renlinear")) {
	BWIPJS.load("bwipp/renlinear.js");
}
if (!BWIPJS.bwipp["telepen"] && BWIPJS.increfs("telepennumeric", "telepen")) {
	BWIPJS.load("bwipp/telepen.js");
}
...
BWIPJS.decrefs("telepennumeric");
// END OF telepennumeric
