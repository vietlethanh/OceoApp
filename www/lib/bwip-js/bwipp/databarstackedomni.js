...
if (!BWIPJS.bwipp["raiseerror"] && BWIPJS.increfs("databarstackedomni", "raiseerror")) {
	BWIPJS.load("bwipp/raiseerror.js");
}
if (!BWIPJS.bwipp["renmatrix"] && BWIPJS.increfs("databarstackedomni", "renmatrix")) {
	BWIPJS.load("bwipp/renmatrix.js");
}
if (!BWIPJS.bwipp["databaromni"] && BWIPJS.increfs("databarstackedomni", "databaromni")) {
...
BWIPJS.decrefs("databarstackedomni");
