...
// BEGIN upce
if (!BWIPJS.bwipp["raiseerror"] && BWIPJS.increfs("upce", "raiseerror")) {
	BWIPJS.load("bwipp/raiseerror.js");
}
if (!BWIPJS.bwipp["renlinear"] && BWIPJS.increfs("upce", "renlinear")) {
	BWIPJS.load("bwipp/renlinear.js");
}
if (!BWIPJS.bwipp["ean2"] && BWIPJS.increfs("upce", "ean2")) {
	BWIPJS.load("bwipp/ean2.js");
}
if (!BWIPJS.bwipp["ean5"] && BWIPJS.increfs("upce", "ean5")) {
...
BWIPJS.bwipp["upce"]=function() {
	...
	function $f12(){
		this.stk[this.ptr++]="bwipp.upcEupcAbadCharacter";
	...
	function $f20(){
		...
		this.stk[this.ptr++]="bwipp.upcEupcAnotCompressible";
	...
	function $f23(){
		this.stk[this.ptr++]="bwipp.upcEbadLength";
	...
	function $f24(){
		this.stk[this.ptr++]="bwipp.upcEbadCharacter";
	...
	function $f26(){
		this.stk[this.ptr++]="bwipp.upcEbadAddOnLength";
	...
	function $f27(){
		this.stk[this.ptr++]="bwipp.upcEbadNumberSystem";
	...
	function $f36(){
		this.stk[this.ptr++]="bwipp.upcEbadCheckDigit";
