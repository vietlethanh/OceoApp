...
// BEGIN pharmacode
if (!BWIPJS.bwipp["raiseerror"] && BWIPJS.increfs("pharmacode", "raiseerror")) {
	BWIPJS.load("bwipp/raiseerror.js");
}
if (!BWIPJS.bwipp["renlinear"] && BWIPJS.increfs("pharmacode", "renlinear")) {
...
BWIPJS.bwipp["pharmacode"]=function() {
	...
	function $f6(){
		this.stk[this.ptr++]="bwipp.pharmacodeBadLength";
		this.stk[this.ptr++]=BWIPJS.psstring("Pharmacode must be 1 to 6 digits");
	...
	function $f7(){
		this.stk[this.ptr++]="bwipp.pharmacodeBadCharacter";
		this.stk[this.ptr++]=BWIPJS.psstring("Pharmacode must contain only digits");
		var t=this.dstk.get("raiseerror");
		this.stk[this.ptr++]=t;
		var t=this.stk[--this.ptr];
		if (t instanceof Function) t.call(this); else this.eval(t);
	...
	function $f9(){
		this.stk[this.ptr++]="bwipp.pharmacodeBadValue";
		this.stk[this.ptr++]=BWIPJS.psstring("Pharmacode value must be between 3 and 131070");
		var t=this.dstk.get("raiseerror");
		this.stk[this.ptr++]=t;
		var t=this.stk[--this.ptr];
		if (t instanceof Function) t.call(this); else this.eval(t);
	...
	this.stk[this.ptr-2]=this.stk[this.ptr-2]/this.stk[this.ptr-1]; this.ptr--;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="nwidth";
	this.stk[this.ptr++]=0.5;
	this.stk[this.ptr++]=2.835;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]*this.stk[this.ptr-1]; this.ptr--;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="wwidth";
	this.stk[this.ptr++]=1.5;
	this.stk[this.ptr++]=2.835;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]*this.stk[this.ptr-1]; this.ptr--;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="swidth";
	this.stk[this.ptr++]=1;
	this.stk[this.ptr++]=2.835;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]*this.stk[this.ptr-1]; this.ptr--;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
