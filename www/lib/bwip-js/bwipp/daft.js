...
// BEGIN daft
if (!BWIPJS.bwipp["raiseerror"] && BWIPJS.increfs("daft", "raiseerror")) {
	BWIPJS.load("bwipp/raiseerror.js");
}
if (!BWIPJS.bwipp["renlinear"] && BWIPJS.increfs("daft", "renlinear")) {
...
BWIPJS.bwipp["daft"]=function() {
	...
	function $f6(){
		this.stk[this.ptr++]="bwipp.daftBadCharacter";
		this.stk[this.ptr++]=BWIPJS.psstring("DAFT must contain only characters D, A, F and T");
