...
// BEGIN itf14
if (!BWIPJS.bwipp["raiseerror"] && BWIPJS.increfs("itf14", "raiseerror")) {
	BWIPJS.load("bwipp/raiseerror.js");
}
if (!BWIPJS.bwipp["renlinear"] && BWIPJS.increfs("itf14", "renlinear")) {
	BWIPJS.load("bwipp/renlinear.js");
}
if (!BWIPJS.bwipp["interleaved2of5"] && BWIPJS.increfs("itf14", "interleaved2of5")) {
...
BWIPJS.bwipp["itf14"]=function() {
	...
	function $f9(){
		this.stk[this.ptr++]="bwipp.itf14badLength";
		this.stk[this.ptr++]=BWIPJS.psstring("ITF-14 must be 13 or 14 digits");
	...
	function $f10(){
		this.stk[this.ptr++]="bwipp.itf14badCharacter";
		this.stk[this.ptr++]=BWIPJS.psstring("ITF-14 must contain only digits");
		var t=this.dstk.get("raiseerror");
		this.stk[this.ptr++]=t;
		var t=this.stk[--this.ptr];
		if (t instanceof Function) t.call(this); else this.eval(t);
	...
	function $f14(){
		this.stk[this.ptr++]="bwipp.itf14badCheckDigit";
		this.stk[this.ptr++]=BWIPJS.psstring("Incorrect ITF-14 check digit provided");
		var t=this.dstk.get("raiseerror");
		this.stk[this.ptr++]=t;
		var t=this.stk[--this.ptr];
		if (t instanceof Function) t.call(this); else this.eval(t);
