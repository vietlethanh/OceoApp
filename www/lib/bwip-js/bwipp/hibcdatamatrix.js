...
if (!BWIPJS.bwipp["raiseerror"] && BWIPJS.increfs("hibcdatamatrix", "raiseerror")) {
	BWIPJS.load("bwipp/raiseerror.js");
}
if (!BWIPJS.bwipp["renmatrix"] && BWIPJS.increfs("hibcdatamatrix", "renmatrix")) {
	BWIPJS.load("bwipp/renmatrix.js");
}
if (!BWIPJS.bwipp["datamatrix"] && BWIPJS.increfs("hibcdatamatrix", "datamatrix")) {
	BWIPJS.load("bwipp/datamatrix.js");
}
BWIPJS.bwipp["hibcdatamatrix"]=function() {
	...
	function $f7(){
		this.stk[this.ptr++]="bwipp.hibcdatamatrixBadCharacter";
		this.stk[this.ptr++]=BWIPJS.psstring("HIBC Data Matrix must contain only digits, capital letters, spaces and the symbols -.$/+%");
	...
	function $f11(){
		this.stk[this.ptr++]="bwipp.hibcdatamatrixBadCheckDigit";
		this.stk[this.ptr++]=BWIPJS.psstring("Incorrect HIBC Data Matrix check digit provided");
		var t=this.dstk.get("raiseerror");
		this.stk[this.ptr++]=t;
		var t=this.stk[--this.ptr];
		if (t instanceof Function) t.call(this); else this.eval(t);
