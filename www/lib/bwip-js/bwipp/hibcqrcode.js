...
// BEGIN hibcqrcode
if (!BWIPJS.bwipp["raiseerror"] && BWIPJS.increfs("hibcqrcode", "raiseerror")) {
	BWIPJS.load("bwipp/raiseerror.js");
}
if (!BWIPJS.bwipp["renmatrix"] && BWIPJS.increfs("hibcqrcode", "renmatrix")) {
	BWIPJS.load("bwipp/renmatrix.js");
}
if (!BWIPJS.bwipp["qrcode"] && BWIPJS.increfs("hibcqrcode", "qrcode")) {
