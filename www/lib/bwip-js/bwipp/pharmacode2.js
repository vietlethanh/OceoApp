...
// BEGIN pharmacode2
if (!BWIPJS.bwipp["raiseerror"] && BWIPJS.increfs("pharmacode2", "raiseerror")) {
	BWIPJS.load("bwipp/raiseerror.js");
}
if (!BWIPJS.bwipp["renlinear"] && BWIPJS.increfs("pharmacode2", "renlinear")) {
...
BWIPJS.bwipp["pharmacode2"]=function() {
	...
	function $f6(){
		this.stk[this.ptr++]="bwipp.pharmacode2BadLength";
		this.stk[this.ptr++]=BWIPJS.psstring("Two-track Pharmacode must be 1 to 6 digits");
	...
	function $f7(){
		this.stk[this.ptr++]="bwipp.pharmacode2badCharacter";
		this.stk[this.ptr++]=BWIPJS.psstring("Two-track Pharmacode must contain only digits");
		var t=this.dstk.get("raiseerror");
		this.stk[this.ptr++]=t;
		var t=this.stk[--this.ptr];
		if (t instanceof Function) t.call(this); else this.eval(t);
	...
	function $f9(){
		this.stk[this.ptr++]="bwipp.pharmacode2badValue";
		this.stk[this.ptr++]=BWIPJS.psstring("Two-track Pharmacode value must be between 4 and 64570080");
		var t=this.dstk.get("raiseerror");
		this.stk[this.ptr++]=t;
		var t=this.stk[--this.ptr];
		if (t instanceof Function) t.call(this); else this.eval(t);
