...
// BEGIN hibcpdf417
if (!BWIPJS.bwipp["raiseerror"] && BWIPJS.increfs("hibcpdf417", "raiseerror")) {
	BWIPJS.load("bwipp/raiseerror.js");
}
if (!BWIPJS.bwipp["renmatrix"] && BWIPJS.increfs("hibcpdf417", "renmatrix")) {
	BWIPJS.load("bwipp/renmatrix.js");
}
if (!BWIPJS.bwipp["pdf417"] && BWIPJS.increfs("hibcpdf417", "pdf417")) {
...
BWIPJS.bwipp["hibcpdf417"]=function() {
	...
	function $f7(){
		this.stk[this.ptr++]="bwipp.hibcpdf417BadCharacter";
		this.stk[this.ptr++]=BWIPJS.psstring("HIBC PDF417 must contain only digits, capital letters, spaces and the symbols -.$/+%");
	...
	function $f11(){
		this.stk[this.ptr++]="bwipp.hibcpdf417BadCheckDigit";
		this.stk[this.ptr++]=BWIPJS.psstring("Incorrect HIBC PDF417 check digit provided");
		var t=this.dstk.get("raiseerror");
		this.stk[this.ptr++]=t;
		var t=this.stk[--this.ptr];
		if (t instanceof Function) t.call(this); else this.eval(t);
