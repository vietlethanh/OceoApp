...
// BEGIN industrial2of5
if (!BWIPJS.bwipp["raiseerror"] && BWIPJS.increfs("industrial2of5", "raiseerror")) {
	BWIPJS.load("bwipp/raiseerror.js");
}
if (!BWIPJS.bwipp["renlinear"] && BWIPJS.increfs("industrial2of5", "renlinear")) {
	BWIPJS.load("bwipp/renlinear.js");
}
if (!BWIPJS.bwipp["code2of5"] && BWIPJS.increfs("industrial2of5", "code2of5")) {
	BWIPJS.load("bwipp/code2of5.js");
}
BWIPJS.bwipp["industrial2of5"]=function() {
	function $f0(){
		return -1;
	}
	function $f1(){
...
BWIPJS.decrefs("industrial2of5");
// END OF industrial2of5
