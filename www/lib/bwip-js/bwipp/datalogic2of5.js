...
// BEGIN datalogic2of5
if (!BWIPJS.bwipp["raiseerror"] && BWIPJS.increfs("datalogic2of5", "raiseerror")) {
	BWIPJS.load("bwipp/raiseerror.js");
}
if (!BWIPJS.bwipp["renlinear"] && BWIPJS.increfs("datalogic2of5", "renlinear")) {
	BWIPJS.load("bwipp/renlinear.js");
}
if (!BWIPJS.bwipp["code2of5"] && BWIPJS.increfs("datalogic2of5", "code2of5")) {
	BWIPJS.load("bwipp/code2of5.js");
}
BWIPJS.bwipp["datalogic2of5"]=function() {
	function $f0(){
		return -1;
	}
	function $f1(){
	...
	var t=this.dstk.get("options");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr++]=BWIPJS.psstring("version");
	this.stk[this.ptr++]=BWIPJS.psstring("datalogic");
	if (this.stk[this.ptr-3] instanceof BWIPJS.psstring || this.stk[this.ptr-3] instanceof BWIPJS.psarray)
		this.stk[this.ptr-3].set(this.stk[this.ptr-2], this.stk[this.ptr-1]);
	else this.stk[this.ptr-3][this.stk[this.ptr-2].toString()]=this.stk[this.ptr-1];
	this.ptr-=3;
...
BWIPJS.decrefs("datalogic2of5");
// END OF datalogic2of5
