...
// BEGIN code2of5
if (!BWIPJS.bwipp["raiseerror"] && BWIPJS.increfs("code2of5", "raiseerror")) {
	BWIPJS.load("bwipp/raiseerror.js");
}
if (!BWIPJS.bwipp["renlinear"] && BWIPJS.increfs("code2of5", "renlinear")) {
...
BWIPJS.bwipp["code2of5"]=function() {
	...
	function $f6(){
		this.stk[this.ptr++]="bwipp.code2of5badCharacter";
		this.stk[this.ptr++]=BWIPJS.psstring("Code 25 must contain only digits");
	...
	function $f11(){
		this.stk[this.ptr++]="bwipp.code2of5badCheckDigit";
		this.stk[this.ptr++]=BWIPJS.psstring("Incorrect Code 25 check digit provided");
		var t=this.dstk.get("raiseerror");
		this.stk[this.ptr++]=t;
		var t=this.stk[--this.ptr];
		if (t instanceof Function) t.call(this); else this.eval(t);
	...
	function $f13(){
		this.stk[this.ptr++]="bwipp.code2of5badVersion";
		this.stk[this.ptr++]=BWIPJS.psstring("Unrecognised Code 25 version");
		var t=this.dstk.get("raiseerror");
		this.stk[this.ptr++]=t;
		var t=this.stk[--this.ptr];
		if (t instanceof Function) t.call(this); else this.eval(t);
	...
	this.stk[this.ptr++]="versions";
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]="industrial";
